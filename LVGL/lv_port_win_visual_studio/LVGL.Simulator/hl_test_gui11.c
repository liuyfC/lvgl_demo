...
LV_FONT_DECLARE(lv_font_sourcehansansCN_16)
LV_FONT_DECLARE(lv_font_sourcehansansCN_8)
...
static const hl_imgbtn_src_t g_wind_btn_blue_src[] = {
    {&tab_icon_wind_auto_nor_blue,       &tab_icon_wind_auto_sel_blue,       "风速", "   auto"},
    {&tab_icon_wind_speed_nor_blue_fan1, &tab_icon_wind_speed_sel_blue_fan1, "风速", "   lv.1"},
    {&tab_icon_wind_speed_nor_blue_fan2, &tab_icon_wind_speed_sel_blue_fan2, "风速", "   lv.2"},
    {&tab_icon_wind_speed_nor_blue_fan3, &tab_icon_wind_speed_sel_blue_fan3, "风速", "   lv.3"},
    {&tab_icon_wind_speed_nor_blue_fan4, &tab_icon_wind_speed_sel_blue_fan4, "风速", "   lv.4"},
    {&tab_icon_wind_speed_nor_blue_fan5, &tab_icon_wind_speed_sel_blue_fan5, "风速", "   lv.5"},
    {&tab_icon_wind_speed_nor_blue_fan6, &tab_icon_wind_speed_sel_blue_fan6, "风速", "   lv.6"},
    {&tab_icon_wind_speed_nor_blue_fan7, &tab_icon_wind_speed_sel_blue_fan7, "风速", "   lv.7"},
};


static const hl_imgbtn_src_t g_wind_btn_green_src[] = {
    {&tab_icon_wind_auto_nor_green,       &tab_icon_wind_auto_sel_green,       "风速", "   auto"},
    {&tab_icon_wind_speed_nor_green_fan1, &tab_icon_wind_speed_sel_green_fan1, "风速", "   lv.1"},
    {&tab_icon_wind_speed_nor_green_fan2, &tab_icon_wind_speed_sel_green_fan2, "风速", "   lv.2"},
    {&tab_icon_wind_speed_nor_green_fan3, &tab_icon_wind_speed_sel_green_fan3, "风速", "   lv.3"},
    {&tab_icon_wind_speed_nor_green_fan4, &tab_icon_wind_speed_sel_green_fan4, "风速", "   lv.4"},
    {&tab_icon_wind_speed_nor_green_fan5, &tab_icon_wind_speed_sel_green_fan5, "风速", "   lv.5"},
    {&tab_icon_wind_speed_nor_green_fan6, &tab_icon_wind_speed_sel_green_fan6, "风速", "   lv.6"},
    {&tab_icon_wind_speed_nor_green_fan7, &tab_icon_wind_speed_sel_green_fan7, "风速", "   lv.7"},
};

static const hl_imgbtn_src_t g_wind_btn_orange_src[] = {
    {&tab_icon_wind_auto_nor_orange,       &tab_icon_wind_auto_sel_orange,       "风速", "   auto"},
    {&tab_icon_wind_speed_nor_orange_fan1, &tab_icon_wind_speed_sel_orange_fan1, "风速", "   lv.1"},
    {&tab_icon_wind_speed_nor_orange_fan2, &tab_icon_wind_speed_sel_orange_fan2, "风速", "   lv.2"},
    {&tab_icon_wind_speed_nor_orange_fan3, &tab_icon_wind_speed_sel_orange_fan3, "风速", "   lv.3"},
    {&tab_icon_wind_speed_nor_orange_fan4, &tab_icon_wind_speed_sel_orange_fan4, "风速", "   lv.4"},
    {&tab_icon_wind_speed_nor_orange_fan5, &tab_icon_wind_speed_sel_orange_fan5, "风速", "   lv.5"},
    {&tab_icon_wind_speed_nor_orange_fan6, &tab_icon_wind_speed_sel_orange_fan6, "风速", "   lv.6"},
    {&tab_icon_wind_speed_nor_orange_fan7, &tab_icon_wind_speed_sel_orange_fan7, "风速", "   lv.7"},
};
...
static const hl_imgbtn_src_t g_mode_btn_src[MODE_MAX] = {
    {&tab_icon_mode_cool_nor, &tab_icon_mode_cool_pre, "模式", "   制冷"},
    {&tab_icon_mode_heat_nor, &tab_icon_mode_heat_pre, "模式", "   制热"},
    {&tab_icon_mode_dehumidification_nor, &tab_icon_mode_dehumidification_pre, "模式", "   除湿"},
    {&tab_icon_mode_wind_nor, &tab_icon_mode_wind_pre, "模式", "   送风"},
    {&tab_icon_mode_auto_nor, &tab_icon_mode_auto_pre, "模式", "   自动"},
};


static const hl_imgbtn_src_t g_mode_bar1_src[MODE_MAX] = {
    {&tab_icon_cool_nor, &tab_icon_cool_blue, "  制冷"},
    {&tab_icon_heat_nor, &tab_icon_heat_orange, "  制热"},
    {&tab_icon_humidification_nor, &tab_icon_humidification_blue, "  除湿"},
    {&tab_icon_wind_nor, &tab_icon_wind_green, "  送风"},
    {&tab_icon_auto_nor, &tab_icon_auto_green, "  自动"},
};


static const hl_imgbtn_src_t g_mode_bar2_src[] = {
    {&sleep_diy_pop_icon_cool2, &sleep_diy_pop_icon_cool, "  制冷"},
    {&bottom_icon_heat1, &bottom_icon_heat2, "  制热"},
};
...
static const hl_imgbtn_src_t g_wind_dir_u_d_btn_src[] = {
    {&tab_icon_wind_direction_up_down_nor, &cool_tab_icon_wind_direction_up_down_sel, "上下"},
    {&tab_icon_wind_direction_up_down_nor, &wind_tab_icon_wind_direction_up_down_sel, "上下"},
    {&tab_icon_wind_direction_up_down_nor, &heat_tab_icon_wind_direction_up_down_sel, "上下"},
};


static const hl_imgbtn_src_t g_wind_dir_l_r_btn_src[] = {
    {&tab_icon_wind_direction_left_right_nor, &cool_tab_icon_wind_direction_left_right_sel, "左右"},
    {&tab_icon_wind_direction_left_right_nor, &wind_tab_icon_wind_direction_left_right_sel, "左右"},
    {&tab_icon_wind_direction_left_right_nor, &heat_tab_icon_wind_direction_left_right_sel, "左右"},
};


static const hl_imgbtn_src_t g_sleep_btn_src[] = {
    {&tab_icon_sleep_nor, &cool_tab_icon_sleep_sel, "睡眠"},
    {&tab_icon_sleep_nor, &wind_tab_icon_sleep_sel, "睡眠"},
    {&tab_icon_sleep_nor, &heat_tab_icon_sleep_sel, "睡眠"},
};
...
static const hl_show_src_t g_show_wind_u_d_src[] = {
    {&aircondition_control_icon_wind_up_down, "上下"},
};

static const hl_show_src_t g_show_wind_l_r_src[] = {
    {&aircondition_control_wind_left_right, "左右"},
};
...
static const hl_show_src_t g_show_wind_sleep_src[] = {
    {&aircondition_control_icon_eco, "睡眠"},
};

static const hl_show_src_t g_show_mode_src[] = {
    {&aircondition_control_icon_cool, "制冷"},
    {&aircondition_control_icon_heat, "制热"},
    {&aircondition_control_icon_dehumidification, "除湿"},
    {&aircondition_control_icon_wind, "送风"},
    {&aircondition_control_icon_auto2, "自动"},
};

static const hl_show_src_t g_show_wind_speed_src[] = {
    {&aircondition_control_icon_auto, "自动"},
    {&aircondition_control_fan1, "静音"},
...
static void hl_imgbtn_event_cb(lv_event_t *e)
{
    ...
    if (lv_event_get_code(e) == LV_EVENT_VALUE_CHANGED)
    {
        ...
        else if (pimgbtn == pgui->tabbar2_imgbtn[btn_id] && btn_id < MODE_DRY)
        {
            ...
            lv_obj_set_style_bg_img_src(pgui->imgbtn[btn_id], g_mode_btn_src[btn_id].nor_src, LV_STATE_DEFAULT);
            lv_obj_set_style_bg_img_src(pgui->imgbtn[btn_id], g_mode_btn_src[btn_id].sel_src, LV_STATE_CHECKED);
...
{
    pgui->imgbtn[btn_id] = lv_btn_create(pgui->scr);

    // lv_obj_remove_style_all(pgui->imgbtn[btn_id]);
    ...
    lv_obj_set_style_bg_img_src(pgui->imgbtn[btn_id], pimgsrc->nor_src, LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_src(pgui->imgbtn[btn_id], pimgsrc->sel_src, LV_STATE_CHECKED);

    lv_obj_add_flag(pgui->imgbtn[btn_id], LV_OBJ_FLAG_CHECKABLE | LV_OBJ_FLAG_SCROLL_ON_FOCUS);
    ...
    if (pimgsrc->text != NULL)
    {
        ...
        lv_obj_set_style_text_font(label, &lv_font_sourcehansansCN_16, LV_PART_MAIN);
    ...
    if (WIND_SPEED_BTN == btn_id)
    {
        ...
        lv_obj_align_to(pgui->label_wind, pgui->imgbtn[btn_id], LV_ALIGN_BOTTOM_MID, 0, 10);
        lv_obj_set_style_text_font(pgui->label_wind, &lv_font_sourcehansansCN_8, LV_PART_MAIN);         
    ...
    else if (MODE_BTN == btn_id)
    {
        ...
        lv_obj_align_to(pgui->label_mode, pgui->imgbtn[btn_id], LV_ALIGN_BOTTOM_MID, 0, 10);
        lv_obj_set_style_text_font(pgui->label_mode, &lv_font_sourcehansansCN_8, LV_PART_MAIN);
        // lv_obj_set_style_text_color(label2, lv_color_make(255, 255, 255), LV_PART_MAIN);
...
static void hl_tabbar1_imgbtn_creat(hl_gui_mcb_t *pgui, hl_mode_idx_e mode, const hl_imgbtn_src_t *pimgsrc, lv_align_t align, int16_t x, int16_t y)
{
    ...
    lv_obj_set_style_text_font(label, &lv_font_sourcehansansCN_8, LV_PART_MAIN);
    // lv_obj_set_style_text_color(label, lv_color_make(255, 255, 255), LV_PART_MAIN);
    lv_obj_set_style_text_align(label, LV_TEXT_ALIGN_CENTER, LV_PART_MAIN);
...
static void hl_set_wind_speed_img(hl_gui_mcb_t *pgui, uint8_t value)
{
    ...
    lv_obj_set_style_bg_img_src(pgui->imgbtn[WIND_SPEED_BTN], pwind_btn_src[value].nor_src, LV_STATE_DEFAULT);
    lv_obj_set_style_bg_img_src(pgui->imgbtn[WIND_SPEED_BTN], pwind_btn_src[value].sel_src, LV_STATE_CHECKED);
...
static int16_t pos[] = {-20, -10, -20, -30, -40, - 50, -60};
...
static void hl_gui_show_img_set(hl_gui_mcb_t *pgui, hl_gui_imgbtn_e btn_id)
{
    ...
    for (i = 2; i < BTN_MAX; i++)
    {
        if ((GET_BIT(pbtn_flag->btn_flag, i) == 1))
        {
            ...
            lv_obj_set_style_text_font(pshow->show_albel[btn_id], &lv_font_sourcehansansCN_8, LV_PART_MAIN);
            lv_obj_align_to(pshow->show_albel[i], pshow->show_img[i], LV_ALIGN_OUT_RIGHT_MID, 0, 0);
...
static void hl_gui_show_img_set_wind(hl_gui_mcb_t *pgui, hl_wind_speed_e speed)
{
    ...
    lv_obj_set_style_text_font(pshow->show_albel[WIND_SPEED_BTN], &lv_font_sourcehansansCN_8, LV_PART_MAIN);
...
static void hl_gui_show_img_set_mode(hl_gui_mcb_t *pgui, hl_mode_idx_e mode_id)
{
    ...
    lv_obj_set_style_text_font(pshow->show_albel[MODE_BTN], &lv_font_sourcehansansCN_8, LV_PART_MAIN);
...
static lv_obj_t *src1;
static lv_obj_t *src2;
